...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-2">
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class=" d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Footer Fast Links Section</li>
                </ol>
            </nav>
            <h2 class="h4">Footer Fast Links Section</h2>
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            @if (App\Models\FastLinks::count() < 5)
                            ...
                            <div class="d-flex  align-items-center justify-content-center flex-md-nowrap">
                                ...
                                <div class="">
                                    <div data-bs-toggle="tooltip" data-bs-placement="top" title="Delete">
                                        <a href="{{ route('admin.front-settings.delete_footer_fast_links_section', $items->id) }}"
                        ...
                        <div class="modal fade" id="modal-edit-{{ $items->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <form
                                        action="{{ route('admin.front-settings.edit_footer_fast_links_section', $items->id) }}"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="wrapper m-auto">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <input type="text" name="name_ar" value="{{ $items->name_ar }}"
                                                        class="form-control"><br>
                                                    <label> Name English </label>
                                                    <input type="text" name="name_en" value="{{ $items->name_en }}"
                                                        class="form-control"><br>

                                                    <label> Link </label>
                                                    <input type="text" name="link" value="{{ $items->link }}"
                                                        class="form-control"><br>
                ...
                <div class="modal fade" id="modal-add" tabindex="-1" role="dialog" aria-labelledby="modal-default"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('admin.front-settings.create_footer_fast_links_section') }}"
                                method="POST" enctype="multipart/form-data">
                                <div class="modal-body">
