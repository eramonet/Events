    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class=" d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">View All Products Section</li>
            </ol>
        </nav>
        <h2 class="h4">View All Products Section</h2>
        ...
        <tbody>
            ...
            @foreach ($items as $items)
                <tr>
                    ...
                    <td>
                        <img src="{{ asset('user_assets/uploads/view_all_products/' . $items->icon) }}" style="width: 50px">
                    </td>
                    ...
                    <div class="modal fade" id="modal-{{ $items->id }}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('admin.front-settings.edit_view_all_products', $items->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="wrapper m-auto">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <input type="text" name="title_ar"
                                                    value="{{ $items->title_ar }}" class="form-control"><br>
                                                <label> Title English </label>
                                                <input type="text" name="title_en"
                                                    value="{{ $items->title_en }}" class="form-control">
                                            </ul>
                                        </div>
