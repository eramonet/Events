        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class=" d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Explore Category</li>
                </ol>
            </nav>
            <h2 class="h4">Explore Category</h2>
                        ...
                        <div class="modal fade" id="modal-{{ $items->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('admin.front-settings.edit_explore_category', $items->id) }}"
