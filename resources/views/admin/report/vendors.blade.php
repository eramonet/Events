    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4"> <i class="fa fa-house"></i> {{ config('app.name') }} Vendors Reports </h1>

            </div>
            <div class="btn-group ms-2 ms-lg-3">
                <a href="{{ route('admin.vendors.export') }}" class="btn btn-outline-success d-inline-flex align-items-center">
                    ...
                    <span> Export Vendors As Excel</span>
                </a>
            </div>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="h5">All Vendors</h2>

                                <div class="fw-extrabold mb-1"> <a href="#">{{ $allVendorsCount }}</a></div>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">All Vendors</h2>
                                <div class="fw-extrabold mb-1">{{ $allVendorsCount }}</div>
                            </div>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="h5">All Male Vendors</h2>

                                <div class="fw-extrabold mb-1"> <a href="#">{{ $allMaleVendorsCount }}</a></div>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">All Male Vendors</h2>
                                <div class="fw-extrabold mb-1">{{ $allMaleVendorsCount }}</div>
                            </div>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="h5">All Female Vendors</h2>

                                <div class="fw-extrabold mb-1"> <a href="#">{{ $allFemaleVendorsCount }}</a></div>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">All Female Vendors</h2>
                                <div class="fw-extrabold mb-1">{{ $allFemaleVendorsCount }}</div>
                            </div>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="h5">All Vendors Registered From Web</h2>

                                <div class="fw-extrabold mb-1"> <a href="#">{{ $allWebVendorsCount }}</a></div>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">All Vendors Registered From Web</h2>
                                <div class="fw-extrabold mb-1">{{ $allWebVendorsCount }}</div>
                            </div>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="h5">All Vendors Registered From Android</h2>

                                <div class="fw-extrabold mb-1"> <a href="#">{{ $allAdnoidVendorsCount }}</a></div>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">All Vendors Registered From Android</h2>
                                <div class="fw-extrabold mb-1">{{ $allAdnoidVendorsCount }}</div>
                            </div>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="h5">All Vendors Registered From Ios</h2>

                                <div class="fw-extrabold mb-1"> <a href="#">{{ $allIosVendorsCount }}</a></div>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">All Vendors Registered From Ios</h2>
                                <div class="fw-extrabold mb-1">{{ $allIosVendorsCount }}</div>
                            </div>
                    ...
                    <div class="card border-0 shadow">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h2 class="fs-5 fw-bold mb-0">Latest 20 Vendors</h2>
                                </div>
                                <div class="col text-end">
                                    <a href="{{ route('admin.vendors.index') }}" class="btn btn-sm btn-primary">See
                                        All Vendors</a>

                                        <a href="{{ route('admin.vendors.export.tweenty') }}" class="btn btn-outline-success d-inline-flex align-items-center">Export Last 20 Vendors As Excel</a>
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    @foreach ($lastTweentyVendors as $user)
                                        <tr>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h2 class="h6 modal-title">{{ $user->admin->name }}</h2>
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            @if (Auth::guard('admin')->user()->hasPermission('vendors-update'))
                                                                <a class="btn btn-primary"
                                                                    href="{{ route('admin.vendors.edit', $user->id) }}"><span
                ...
                <div class="col-12 mb-4">
                    <div class="card border-0 shadow">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h2 class="fs-5 fw-bold mb-0">Latest 20 Male Vendors</h2>
                                </div>
                                <div class="col">
                                    <a href="{{ route('admin.vendors.export.tweenty.male') }}" class="btn btn-outline-success d-inline-flex align-items-center" style="margin-left: 200px">Export Last 20 Male Vendors As Excel</a>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    @foreach ($lastTweentyMaleVendors as $user)
                                        <tr>
                                            <th class="text-gray-900" scope="row">
                                                {{ $user->admin->name }}
                                            </th>
                ...
                <div class="col-12 mb-4">
                    <div class="card border-0 shadow">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h2 class="fs-5 fw-bold mb-0">Latest 20 Female Vendors</h2>
                                </div>
                                <div class="col">
                                    <a href="{{ route('admin.vendors.export.tweenty.female') }}" class="btn btn-outline-success d-inline-flex align-items-center" style="margin-left: 200px">Export Last 20 Female Vendors As Excel</a>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    @foreach ($lastTweentyFemaleVendors as $user)
                                        <tr>
                                            <th class="text-gray-900" scope="row">
                                                {{ $user->admin->name }}
                                            </th>
                ...
                <div class="col-12 mb-4">
                    <div class="card border-0 shadow">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h2 class="fs-5 fw-bold mb-0">Latest 20 Vendors Registered From Web</h2>
                                </div>
                                <div class="col">
                                    <a href="{{ route('admin.vendors.export.tweenty.web') }}" class="btn btn-outline-success d-inline-flex align-items-center" style="margin-left: 200px">Export Last 20 Vendors Registered From Web As Excel</a>
                                </div>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    @foreach ($lastTweentyWebVendors as $user)
                                        <tr>
                                            <th class="text-gray-900" scope="row">
                                                {{ $user->admin->name }}
                                            </th>
                ...
                <div class="col-12 mb-4">
                    <div class="card border-0 shadow">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h2 class="fs-5 fw-bold mb-0">Latest 20 Vendors Registered From Android</h2>
                                </div>
                                <div class="col">
                                    <a href="{{ route('admin.vendors.export.tweenty.android') }}" class="btn btn-outline-success d-inline-flex align-items-center" style="margin-left: 200px">Export Last 20 Vendors Registered From Android As Excel</a>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    @foreach ($lastTweentyAndoridVendors as $user)
                                        <tr>
                                            <th class="text-gray-900" scope="row">
                                                {{ $user->admin->name }}
                                            </th>
                ...
                <div class="col-12 mb-4">
                    <div class="card border-0 shadow">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h2 class="fs-5 fw-bold mb-0">Latest 20 Vendors Registered From Ios</h2>
                                </div>
                                <div class="col">
                                    <a href="{{ route('admin.vendors.export.tweenty.ios') }}" class="btn btn-outline-success d-inline-flex align-items-center" style="margin-left: 200px">Export Last 20 Vendors Registered From Ios As Excel</a>
                                </div>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    @foreach ($lastTweentyIosVendors as $user)
                                        <tr>
                                            <th class="text-gray-900" scope="row">
                                                {{ $user->admin->name }}
                                            </th>
