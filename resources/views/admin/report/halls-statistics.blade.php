    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4"> <i class="fa fa-house"></i> Halls Statistics </h1>
                    ...
                    <div class="row d-block d-xl-flex align-items-center">
                        ...
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">All Halls</h2>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="h5">All Active Halls</h2>

                                <div class="fw-extrabold mb-1"> <a href="#">{{ $hallsActiveCount }}</a></div>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">All Active Halls</h2>
                                <div class="fw-extrabold mb-1">{{ $hallsActiveCount }}</div>
                            </div>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="h5">All UnActive Halls</h2>

                                <div class="fw-extrabold mb-1"> <a href="#">{{ $hallsUnActiveCount }}</a></div>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">All UnActive Halls</h2>
                                <div class="fw-extrabold mb-1">{{ $hallsUnActiveCount }}</div>
                            </div>
