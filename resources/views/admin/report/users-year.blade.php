    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4"> <i class="fa fa-file"></i>Users year report</h1>
        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-header d-flex flex-row align-items-center flex-0 border-bottom">
                    ...
                    <div class="d-block">
                        <div class="h3 fw-normal text-gray mb-2">Totalc chart of registered users year</div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-bolder text-gray-500 ">
                                                        ...
                                                        <span class="d-block text-nowrap"><i
                                                                class="fas fa-calendar-year text-info"></i>
                ...
                const config = {
                    ...
                    options: {
                        ...
                        plugins: {
                            title: {
                                display: false,
                                text: (ctx) => 'Current year  Total Income Is 910,500,00 EGP',
                            }
                        }
                    }
                };
