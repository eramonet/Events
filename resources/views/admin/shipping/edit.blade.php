              ...
              {{-- text_ar --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input dir="rtl" required type="text" name="text_ar" class="form-control @error('text_ar') is-invalid @enderror" value="{{ $shipping->text_ar }}">
                    </div>
              ...
              {{-- text_en --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="text" name="text_en" class="form-control @error('text_en') is-invalid @enderror" value="{{$shipping->text_en}}">
                    </div>
                   ...
                   <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <select required name="city_id" id="city_id" class="form-select @error('city_id') is-invalid @enderror">
                            ...
                            <option value="{{ $city->id }}" {{ $shipping->city_id == $city->id ?'selected':''}}>{{  $city->title_en }}</option>
                            @endforeach
                        </select>
                    </div>
            ...
            {{-- cost --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="number" name="cost" class="form-control @error('cost') is-invalid @enderror" value="{{  $shipping->cost }}">
                    </div>
