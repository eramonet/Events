            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ $user->name  }}">
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{  $user->email   }}">
                    </div>
              ...
              {{-- phone --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{  $user->phone   }}">
                    </div>
                   ...
                   <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <select required name="country_id" id="country_id" class="form-select @error('country_id') is-invalid @enderror">
                            ...
                            <option value="{{ $country->id }}" {{  $user->country_id  == $country->id ?'selected':''}}>{{  $country->title_en }}</option>
                            @endforeach
                        </select>
                    </div>
                   ...
                   <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <select required name="city_id" id="city_id" class="form-select @error('city_id') is-invalid @enderror">
                            ...
                            <option value="{{ $city->id }}" {{ $user->city_id == $city->id ?'selected':''}}>{{  $city->title_en }}</option>
                            @endforeach
                        </select>
                    </div>
        ...
        <div class="card-body">
                {{-- image --}}
                    ...
                    <div class="form-group mb-4 d-flex justify-content-center">
                        <input  accept="image/*" data-default-file="{{ $user->image_url }}"   type="file" name="image"  data-max-file-size="10M" class="dropify @error('image') is-invalid @enderror" value="{{ old('image') }}">
                    </div>
