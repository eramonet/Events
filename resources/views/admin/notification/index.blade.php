                ...
                @foreach ($notifications as $notification)
                    ...
                    <td>
                        ...
                        <div class="m-auto" style="width:250px">
                            <p class="" dir="rtl">{{ Str::limit($notification->title_ar, 60) }}</p>
                            <p class="">{{ Str::limit($notification->title_en, 60) }}</p>
                        </div>
                    </td>
                    ...
                    <td>
                        @if ($notification->created_at)
                            <span class="text-nowrap d-block h6"><i class="fas fa-calendar-week text-info"></i>
                                {{ \Carbon\Carbon::parse($notification->created_at)->format('d/m/Y') }} </span>
                            <span class="text-nowrap d-block h6"><i class="fas fa-clock text-success"></i>
                                {{ \Carbon\Carbon::parse($notification->created_at)->format('h:i:s A') }} </span>
                        @else
                            ...
                        @endif
