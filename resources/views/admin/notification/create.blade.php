            ...
            {{-- description_ar --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <textarea required  dir="rtl" name="desc_ar" id="desc_ar"   cols="30" rows="3" class="form-control @error('desc_ar') is-invalid @enderror">{{old('desc_ar')}}</textarea>
                    </div>
            ...
            {{-- description_en --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <textarea  required name="desc_en" id="desc_en"   cols="30" rows="3" class="form-control @error('desc_en') is-invalid @enderror">{{  old('desc_en')}}</textarea>
                    </div>
      ...
      {{-- user type --}}
                <div class="col-md-12">
                    <div class="form-group mb-4">
                        ...
                        <select required name="user_type" id="user_type" class="form-select @error('user_type') is-invalid @enderror">
                             <option value="0" {{ old('user_type') =='0'?'selected':''}}>One user or many users</option>
                             ...
                             <option value="4" {{ old('user_type') =='4'?'selected':''}}>One vendor or many vendor</option>
                             <option value="5" {{ old('user_type') =='5'?'selected':''}}>All vendors</option>
                ...
                {{-- user type --}}
                   ...
                   <div id="users" class="col-md-12 showOrHide">
                    <div class="form-group mb-4">
                        ...
                        <select multiple name="user_id[]" id="user_id" class="form-select @error('user_id') is-invalid @enderror">
       ...
       {{-- user type --}}
                   ...
                   <div id="vendors" class="col-md-12 showOrHide" style="display: none">
                    <div class="form-group mb-4">
                        ...
                        <select multiple name="vendor_id[]" id="vendor_id" class="form-select @error('vendor_id') is-invalid @enderror">
