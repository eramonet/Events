...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-2">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">All FAQ`s</h2>

        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            @if (Auth::guard('admin')->user()->hasPermission('faqs-create'))
                <a href="{{ route('admin.faqs.create') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
            ...
            <div class="btn-group ms-2 ms-lg-3">
                <a href="{{ route('admin.faqs.export') }}" class="btn btn-outline-success d-inline-flex align-items-center">
            ...
            <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="accordion-body card card-body ">
                        ...
                        <form action="{{ route('admin.faqs.index') }}">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="m-auto" style="width:250px">
                                <p class="" dir="rtl">{{ Str::limit($faq->answer_ar, 60) }}</p>
                                <p class="">{{ Str::limit($faq->answer_en, 60) }}</p>
                            </div>
                        </td>

                        <td>
                            @if ($faq->category)
                                <a href="{{ route('admin.faq-categories.index', ['id' => $faq->category->id]) }}">
                                    <span class="badge bg-primary " style="font-size: 14px ;padding:10px ">
                                        {{ Str::limit($faq->category->title_en, 10) . ' - ' . Str::limit($faq->category->title_ar ,10)}}
                                    </span></a>
                            @else
                                --
                            @endif
                        ...
                        <td>
                            @if ($faq->created_at)
                                <span class="text-nowrap d-block h6"><i class="fas fa-calendar-week text-info"></i>
                                    {{ \Carbon\Carbon::parse($faq->created_at)->format('d/m/Y') }} </span>
                                <span class="text-nowrap d-block h6"><i class="fas fa-clock text-success"></i>
                                    {{ \Carbon\Carbon::parse($faq->created_at)->format('h:i:s A') }} </span>
                            @else
                                ...
                            @endif
                        ...
                        <td>
                            ...
                            <div class="d-flex  align-items-center justify-content-center flex-md-nowrap">
                                ...
                                <div class="">
                                    <div data-bs-toggle="tooltip" data-bs-placement="top" title="Show Details">
                                        <button class="btn btn-primary  m-1" data-bs-toggle="modal"
                                            data-bs-target="#modal-{{ $faq->id }}" class=""><span
                                ...
                                <div class="">
                                    @if (Auth::guard('admin')->user()->hasPermission('faqs-update'))
                                        <a class="btn btn-info m-1" class="dropdown-item"
                                            href="{{ route('admin.faqs.edit', $faq->id) }}" title="Edit"
                                ...
                                <div class="">
                                    @if ($faq->deleted_at)
                                        @if (Auth::guard('admin')->user()->hasPermission('faqs-update'))
                                            <form action="{{ route('admin.faqs.restore', $faq->id) }}" method="POST"
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h2 class="h6 modal-title">{{ $faq->title_en }}</h2>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="wrapper m-auto">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item">Answer In Arabic : {{ $faq->answer_ar }} </li>
                                                <li class="list-group-item">Answer In English : {{ $faq->answer_en }}</li>
                                                <li class="list-group-item">Question In Arabic : {{ $faq->question_ar }}
                                                </li>
                                                <li class="list-group-item">Question In English : {{ $faq->question_en }}
                                                </li>
                                                ...
                                                <li class="list-group-item">Category :
                                                    ...
                                                    @if ($faq->category)
                                                        <a
                                                            href="{{ route('admin.faq-categories.index', ['id' => $faq->category->id]) }}">
                                                            <span class="badge bg-primary "
                                                                style="font-size: 14px ;padding:10px ">
                                                                {{ $faq->category->title_en . ' - ' . $faq->category->title_ar }}
                                                            </span></a>
                                                    @else
                                                        --
                                                    @endif
                                                ...
                                                <li class="list-group-item">Added By :
                                                    ...
                                                    @if ($faq->admin)
                                                        <a class="btn btn-outline-primary"
                                                            href="{{ route('admin.faqs.index', ['admin_id' => $faq->admin->id]) }}">{{ $faq->admin->name }}</a>
                                                    @else
                                                        --
                                                    @endif
                                                ...
                                                <li class="list-group-item">Added Date : <i
                                                    ...
                                                    {{ \Carbon\Carbon::parse($faq->created_at)->format('d/m/Y') }} </li>
                                                <li class="list-group-item">Added Time : <i
                                                        class="fas fa-clock text-success"></i>
                                                    {{ \Carbon\Carbon::parse($faq->created_at)->format('h:i:s A') }}</li>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        @if (Auth::guard('admin')->user()->hasPermission('faqs-update'))
                                            <a class="btn btn-primary"
                                                href="{{ route('admin.faqs.edit', $faq->id) }}"><span
