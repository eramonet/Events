...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        ...
        <h2 class="h4">Create New Page</h2>
...
<form action="{{ route('admin.pages.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group mb-4">
                    ...
                    <input  type="text" name="youtube_video_link" class="form-control @error('youtube_video_link') is-invalid @enderror" value="{{ old('youtube_video_link') }}">
                </div>
    ...
    <div class="col-md-12">
        <div class="form-group mb-4">
            ...
            <textarea editor  dir="rtl" name="content_ar" id="content_ar"   cols="30" rows="6" class="form-control @error('content_ar') is-invalid @enderror">{!! old('content_ar') !!}</textarea>
        </div>
...
{{-- content_en --}}
    <div class="col-md-12">
        <div class="form-group mb-4">
            ...
            <textarea editor  name="content_en" id="content_en"   cols="30" rows="6" class="form-control @error('content_en') is-invalid @enderror">{!! old('content_en') !!}</textarea>
        </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
                {{-- image --}}
                     ...
                     <span>Prefer {{ config('imageDimensions.pages.width').'*'. config('imageDimensions.pages.height') }} Pexel</span>
