...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-2">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">All Dynamic Pages</h2>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="m-auto" style="width:250px">
                                <p class="" dir="rtl">{{ Str::limit($page->title_ar, 60) }}</p>
                                <p class="">{{ Str::limit($page->title_en, 60) }}</p>
                            </div>
                        </td>
                        ...
                        <td>
                            @if ($page->created_at)
                                ...
                                <span class="text-nowrap d-block h6"><i class="fas fa-clock text-success"></i>
                                    {{ \Carbon\Carbon::parse($page->created_at)->format('h:i:s A') }} </span>
                            @else
                                ...
                            @endif
                                ...
                                <div class="">
                                    <div data-bs-toggle="tooltip" data-bs-placement="top" title="Show Details">
                                        <button class="btn btn-primary  m-1" data-bs-toggle="modal"
                                            data-bs-target="#modal-{{ $page->id }}" class=""><span
                                ...
                                <div class="">
                                    @if (Auth::guard('admin')->user()->hasPermission('pages-update'))
                                        <a class="btn btn-info m-1" class="dropdown-item"
                                            href="{{ route('admin.pages.edit', $page->id) }}" title="Edit"
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="wrapper m-auto">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item">Title In Arabic : {{ $page->title_ar }} </li>
                                                <li class="list-group-item">Title In English : {{ $page->title_en }} </li>

                                                <li class="list-group-item">Views : {{ $page->views }}</li>

                                                <li class="list-group-item">Added By :

                                                    @if ($page->admin)
                                                        <a class="btn btn-outline-primary"
                                                            href="{{ route('admin.admins.index', ['admin_id' => $page->admin->id]) }}">{{ $page->admin->name }}</a>
                                                    @else
                                                        --
                                                    @endif
                                                ...
                                                <li class="list-group-item">Added Date : <i
                                                    ...
                                                    {{ \Carbon\Carbon::parse($page->created_at)->format('d/m/Y') }} </li>
                                                <li class="list-group-item">Added Time : <i
                                                        class="fas fa-clock text-success"></i>
                                                    {{ \Carbon\Carbon::parse($page->created_at)->format('h:i:s A') }}</li>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        @if (Auth::guard('admin')->user()->hasPermission('pages-update'))
                                            <a class="btn btn-primary"
                                                href="{{ route('admin.pages.edit', $page->id) }}"><span
