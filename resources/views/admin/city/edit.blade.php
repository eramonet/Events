                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <input dir="rtl" required type="text" name="title_ar"
                                class="form-control @error('title_ar') is-invalid @enderror" value="{{ $city->title_ar }}">
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <input required type="text" name="title_en"
                                class="form-control @error('title_en') is-invalid @enderror" value="{{ $city->title_en }}">
                        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-4 d-flex justify-content-center">
                    <input accept="image/*" data-default-file="{{ $city->image }}" type="file" name="image"
