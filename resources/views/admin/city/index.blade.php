                        ...
                        <td>
                            @if ($city->created_at)
                                <p><i class="fas fa-calendar-week text-info"></i>
                                    {{ \Carbon\Carbon::parse($city->created_at)->format('d/m/Y') }} </p>
                                <p><i class="fas fa-clock text-success"></i>
                                    {{ \Carbon\Carbon::parse($city->created_at)->format('h:i:s A') }} </p>
                            @else
                                ...
                            @endif
                                        ...
                                        <div class="wrapper m-auto">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item">Added By :
                                                    ...
                                                    @if ($city->admin)
                                                        <a class="btn btn-outline-primary"
                                                            href="{{ route('admin.system-admins.index', ['admin_id' => $city->admin->id]) }}">{{ $city->admin->name }}</a>
                                                    @else
                                                        --
                                                    @endif
