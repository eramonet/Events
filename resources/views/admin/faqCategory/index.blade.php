...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-2">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">All FAQ Categories</h2>

        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            @if (Auth::guard('admin')->user()->hasPermission('faq-categories-create'))
            ...
            <div class="btn-group ms-2 ms-lg-3">
                <a href="{{ route('admin.faq-categories.export') }}"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="d-flex  align-items-center justify-content-center flex-md-nowrap">
                                ...
                                <div class="">
                                    @if (Auth::guard('admin')->user()->hasPermission('faq-categories-update'))
                                        <a class="btn btn-info m-1" class="dropdown-item"
                                            href="{{ route('admin.faq-categories.edit', $category->id) }}" title="Edit"
                                ...
                                <div class="">
                                    @if ($category->deleted_at)
                                        @if (Auth::guard('admin')->user()->hasPermission('faq-categories-update'))
                                            <form action="{{ route('admin.faq-categories.restore', $category->id) }}" method="POST"
                                        ...
                                        @endif
                                    @else
                                        @if (Auth::guard('admin')->user()->hasPermission('faq-categories-delete'))
                                            <form class="delete-btn m-0 p-0 "
                                                action="{{ route('admin.faq-categories.destroy', $category->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="wrapper m-auto">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item">Added By :
                                                    ...
                                                    @if ($category->admin)
                                                        <a class="btn btn-outline-primary"
                                                            href="{{ route('admin.admins.index', ['admin_id' => $category->admin->id]) }}">{{ $category->admin->name }}</a>
                                                    @else
                                                        --
                                                    @endif
                                                ...
                                                <li class="list-group-item">FAQ Count :
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        @if (Auth::guard('admin')->user()->hasPermission('faq-categories-update'))
                                            <a class="btn btn-primary"
                                                href="{{ route('admin.faq-categories.edit', $category->id) }}"><span
