...
@section('content')
        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class=" d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Withdraw Needed From You</li>
                </ol>
            </nav>
        ...
        <div class="accordion-item">
            ...
            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                ...
                <div class="accordion-body card card-body ">
                    ...
                    <form action="{{ route('admin.with-draw-request.filter_to_you') }}" method="Get">
                        @csrf
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-4">
    ...
    <div class="alert my-4 text-center text-white" style="background: #1f2937">
        <p class="h2">Total Sent Money <span class="badge badge-lg bg-success "
            style="font-size: 30px">{{ number_format($total_sent_money) }}
        </span> AED </p>
