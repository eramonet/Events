                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <select required name="type" id="type"
                            class="form-select @error('status') is-invalid @enderror">
                            <option value="product" {{ $vendor->type == 'product' ? 'selected' : '' }}>products</option>
                            <option value="hall" {{$vendor->type == 'hall' ? 'selected' : '' }}>Halls</option>
                            <option value="product_hall" {{ $vendor->type == 'product_hall' ? 'selected' : '' }}>Products and Halls</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <select required name="country_id" id="countrys"
                            ...
                            @foreach ($countrys as $country)
                                <option value="{{ $country->id }}" {{ old('country_id') }} @if($country->id == $vendor->country_id ) selected  @endif>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <select required name="city_id" id="city"
                            ...
                            <option value="{{ $city->id }}" {{ old('city') }} @if($city->id == $vendor->city_id ) selected  @endif>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <select required name="region_id" id="region"
                            ...
                            <option value="{{ $region->id }}" {{ old('city') }} @if($region->id == $vendor->city_id ) selected  @endif>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <select required name="account" id="account"
                            ...
                            <option value="individual" {{ $vendor->account == 'individual' ? 'selected' : '' }}>individual
                            </option>
                            <option value="company" {{ $vendor->account== 'company' ? 'selected' : '' }}>company</option>
                        </select>
                    </div>
