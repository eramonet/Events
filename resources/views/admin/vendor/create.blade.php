        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class=" d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Create New Vendor</li>

                </ol>
            </nav>
            <h2 class="h4">Create New Vendor</h2>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <select required name="type" id="type"
                                class="form-select @error('status') is-invalid @enderror">
                                <option value="product" {{ old('type') == 'product' ? 'selected' : '' }}>products</option>
                                <option value="hall" {{ old('type') == 'hall' ? 'selected' : '' }}>Halls</option>
                                <option value="product_hall" {{ old('type') == 'product_hall' ? 'selected' : '' }}>Products and Halls</option>
                            </select>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <select required name="account" id="account"
                                ...
                                <option value="individual" {{ old('account') == 'individual' ? 'selected' : '' }}>individual
                                </option>
                                <option value="company" {{ old('account') == 'company' ? 'selected' : '' }}>company</option>
                            </select>
                        </div>
