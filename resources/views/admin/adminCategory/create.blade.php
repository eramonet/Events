    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class=" d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Create New Admin Categoy</li>

            </ol>
        </nav>
        <h2 class="h4">Create New Admin Categoy</h2>
...
<form action="{{ route('admin.admin-categories.store') }}" method="POST" enctype="multipart/form-data">
...
{{-- details_ar --}}
    <div class="col-md-6">
        <div class="form-group mb-4">
            ...
            <textarea  dir="rtl" name="details_ar" id="details_ar"   cols="30" rows="6" class="form-control @error('details_ar') is-invalid @enderror">{{old('details_ar')}}</textarea>
        </div>
...
{{-- details_en --}}
    <div class="col-md-6">
        <div class="form-group mb-4">
            ...
            <textarea  name="details_en" id="details_en"   cols="30" rows="6" class="form-control @error('details_en') is-invalid @enderror">{{old('details_en')}}</textarea>
        </div>
