    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class=" d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Admin Categories</li>
            </ol>
        </nav>
        <h2 class="h4">All Admin Categories</h2>

    </div>
    <div class="btn-toolbar mb-2 mb-md-0">
        @if (Auth::guard('admin')->user()->hasPermission('admin-categories-create'))
        <a href="{{ route('admin.admin-categories.create') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
        ...
        <div class="btn-group ms-2 ms-lg-3">
            <a href="{{ route('admin.admin-categories.export') }}" class="btn btn-outline-success d-inline-flex align-items-center">
                {{-- <svg class="icon icon-xs me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg> --}}
            ...
            <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionPricing">
                  <div class="accordion-body card card-body ">
                    ...
                    <form action="{{ route('admin.admin-categories.index') }}">
                ...
                <td>
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu py-0">
                            ...
                            @if (Auth::guard('admin')->user()->hasPermission('admin-categories-update'))
                            <a class="dropdown-item" href="{{ route('admin.admin-categories.edit', $category->id) }}"><span class="fas fa-edit me-2"></span>Edit</a>
                            ...
                            @if (Auth::guard('admin')->user()->hasPermission('admin-categories-update'))
                            <form  action="{{ route('admin.admin-categories.restore', $category->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                            ...
                            @endif
                            @else
                            @if (Auth::guard('admin')->user()->hasPermission('admin-categories-delete'))
                            <form class="delete-btn" action="{{ route('admin.admin-categories.destroy', $category->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="wrapper m-auto">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item">Details In Arabic : {{ $category->details_ar }} </li>
                                        <li class="list-group-item">Details In English : {{ $category->details_en }} </li>

                                        <li class="list-group-item"> System Admins Count In This Category :
                                            <span class="badge bg-success">{{ $category->system_admins_count }}</span>


                                        </li>
                                        <li class="list-group-item"> Vendors Admins Count In This Category :
                                             <span class="badge bg-success">{{ $category->vendor_admins_count }} </span>
                                        </li>
                                        ...
                                        <li class="list-group-item">Added By :
                                            ...
                                            @if ($category->added_by_admin)

                                            <a class="btn btn-outline-primary" href="{{ route('admin.system-admins.index' ,[ 'admin_id'=>$category->added_by_admin->id ] )}}">{{ $category->added_by_admin->name }}</a>
                                            @else
                                               --
                                            @endif
                            ...
                            <div class="modal-footer">
                                ...
                                @if (Auth::guard('admin')->user()->hasPermission('admin-categories-update'))
                                <a class="btn btn-primary" href="{{ route('admin.admin-categories.edit', $category->id) }}"><span class="fas fa-edit me-2"></span>Edit</a>
