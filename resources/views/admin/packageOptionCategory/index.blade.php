    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class=" d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">All Extra Decorations</li>
            </ol>
        </nav>
        <h2 class="h4">All Extra Decorations</h2>

    </div>
    <div class="btn-toolbar mb-2 mb-md-0">
        @if (Auth::guard('admin')->user()->hasPermission('packages-options-categories-create'))
        <a href="{{ route('admin.packages-options-categories.create') }}"
            ...
            Create New Extra Decorations
        </a>
        @endif

        <div class="btn-group ms-2 ms-lg-3">
            <a href="{{ route('admin.packages-options-categories.export') }}"
        ...
        <div class="accordion-item">
            ...
            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                ...
                <div class="accordion-body card card-body ">
                    ...
                    <form action="{{ route('admin.packages-options-categories.index') }}">
...
<div class="card card-body border-0 shadow table-wrapper table-responsive">
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $category->id }}</td>
                <td><img src="{{ $category->image_url }}" width="50px"></td>
                ...
                <td>
                    ...
                    <p><i class="fas fa-calendar-week text-info"></i>
                        {{ \Carbon\Carbon::parse($category->created_at)->format('d/m/Y') }} </p>
                    <p><i class="fas fa-clock text-success"></i>
                        {{ \Carbon\Carbon::parse($category->created_at)->format('h:i:s A') }} </p>
                    @else
                    ...
                    @endif
                ...
                <td>
                    ...
                    <a href="{{ route('admin.packages-options-categories.show' , $category->id) }}"
                        class="btn btn-info"><span class="fas fa-eye"></span></a>

                    @if (Auth::guard('admin')->user()->hasPermission('packages-options-categories-update') && $category->can == "yes")
                    <a class="btn btn-primary"
                        href="{{ route('admin.packages-options-categories.edit', $category->id) }}"><span
                            class="fas fa-edit"></span></a>
                    @endif


                    @if (Auth::guard('admin')->user()->hasPermission('packages-options-categories-delete') && $category->can == "yes")
                    <form style="display: contents" class="delete-btn"
                        action="{{ route('admin.packages-options-categories.destroy', $category->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
...
<<<<<<< HEAD
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="wrapper m-auto">
                                    ...
                                    <div class="d-flex mb-2">
                                        <img class="model-img" src="{{ $category->image_url }}"
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item">Added By :
                                            ...
                                            <a class="btn btn-outline-primary"
                                                href="{{ route('admin.system-admins.index', ['admin_id' => $category->admin->id]) }}">{{
                                                $category->admin->name }}</a>
                                            @else
                                            --
                                            @endif
                                        ...
                                        <li class="list-group-item">Packages Options Count :
                                            @if ($category->options_count > 0)
                                            <a class="btn btn-outline-primary"
                                                href="{{ route('admin.packages-options.index', ['category_id' => $category->id]) }}">{{
                                                $category->options_count }}</a>
                                            @else
                                            0
                                            @endif
                            ...
                            <div class="modal-footer">
                                ...
                                @if (Auth::guard('admin')->user()->hasPermission('packages-options-categories-update'))
                                <a class="btn btn-primary"
                                    href="{{ route('admin.packages-options-categories.edit', $category->id) }}"><span
    ...
    @if ($categories->count() < 1) <div class="d-flex justify-content-center" style="min-height: 300px">
        Empty
</div>
@endif
</div>
                ...
                @foreach ($categories as $category)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.packages-options-categories.show' , $category->id) }}" class="btn btn-info"><span class="fas fa-eye"></span></a>
                            ...
                            @if ($category->deleted_at)
                                @if (Auth::guard('admin')->user()->hasPermission('packages-options-categories-update'))
                                    <form style="display: contents" action="{{ route('admin.packages-options-categories.restore', $category->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                ...
                                @endif
                            @else
                                @if (Auth::guard('admin')->user()->hasPermission('packages-options-categories-delete'))
                                    <form style="display: contents" class="delete-btn"
                                        action="{{ route('admin.packages-options-categories.destroy', $category->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger">
                                        ...
                                        <div class="wrapper m-auto">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item">Packages Options Count :
                                                    @if ($category->options_count > 0)
                                                        <a class="btn btn-outline-primary"
                                                            href="{{ route('admin.packages-options.index', ['category_id' => $category->id]) }}">{{ $category->options_count }}</a>
                                                    @else
                                                        0
                                                    @endif
