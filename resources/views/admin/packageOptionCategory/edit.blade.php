...
@section('title')
Edit  Packages Options Category
@endsection
@section('content')
{{-- on top --}}
    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class=" d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item ">
                    <a href="{{ route('admin.packages-options-categories.index') }}">Packages Options Categories</a>
                </li>

                <li class="breadcrumb-item active" aria-current="page">Edit  Packages Options Category</li>

            </ol>
        </nav>
        <h2 class="h4">Edit  Packages Options Category</h2>
...
<form action="{{ route('admin.packages-options-categories.update' , $category->id) }}" method="POST" enctype="multipart/form-data">
