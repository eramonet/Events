...
@section('title')
Create New Packages Options Category
@endsection
@section('content')
{{-- on top --}}
    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class=" d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Create New Packages Options Category</li>

            </ol>
        </nav>
        <h2 class="h4">Create New Packages Options Category</h2>
...
<form action="{{ route('admin.packages-options-categories.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
                {{-- image --}}
                    ...
                    <div class="form-group mb-4 d-flex justify-content-center">
                        <input  type="file" name="image" accept="image/*"  data-max-file-size="10M" class="dropify @error('image') is-invalid @enderror" value="{{ old('image') }}">
                    </div>
