            ...
            <div class="">
                <div data-bs-toggle="tooltip" data-bs-placement="top">
                    <button class="btn btn-primary  m-1" data-bs-toggle="modal"
                        data-bs-target="#modal-create" class="">Create New Color
                    </button>
                </div>
            </div>
            @endif
                            ...
                            <div class="wrapper m-auto">
                               ...
                               <Form action="{{ route('admin.colors.store') }}" method="Post">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input dir="rtl" required type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}">
                                </div>
                                @error('name')
                                ...
                                <div class="">
                                    ...
                                    <input dir="rtl" required type="color" name="code" class=" @error('code') is-invalid @enderror" value="{{ old('code') }}">
                                </div>
                                @error('code')
                                <div class="d-flex justify-content-center ">
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="m-auto" style="width:200px">
                                ...
                                <p class="">{{ Str::limit($color->name, 40) }}</p>
                            </div>
                        </td>
                        <td>
                            ...
                            <div class="m-auto d-flex" style="width:200px">
                                ...
                                <p class="">{{ Str::limit($color->code, 40) }}</p>
                                <div style="width: 20px;height: 20px; background-color: {{ $color->code }}; margin-left:20px;" ></div>
                            </div>
                        </td>
                        ...
                        <div class="modal fade" id="modal-{{ $color->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h2 class="h6 modal-title">{{ $color->Name }}</h2>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        ...
                                        <div class="wrapper m-auto">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item">Name: {{ $color->name }}
                                                </li>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="wrapper m-auto">
                                            ...
                                            <Form action="{{ route('admin.colors.update',$color->id) }}" method="Post">
                                                ...
                                                <div class="form-group mb-4">
                                                    <label for="title_ar">Name<span class="text-danger">*</span></label>
                                                    <input  required type="text" value="{{ $color->name }}" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}">
                                                </div>
                                                @error('name')
                                                <div class="d-flex justify-content-center ">
                                                ...
                                                <div class="">
                                                    <label for="title_ar">Code<span class="text-danger">*</span></label>
                                                    <input  required type="color" value="{{ $color->code }}" name="code" class=" @error('code') is-invalid @enderror" value="{{ old('code') }}">
                                                </div>
                                                @error('code')
                                                <div class="d-flex justify-content-center ">
