...
@section('content')
            ...
            <div class="d-flex justify-content-center align-items-center flex-wrap">
                ...
                <div class="card card-body px-1 py-3 mx-4 p bg-success   rounded my-3 order-statistics  position-relative">
                    ...
                    <a href="{{ route('admin.with-draw-request.total_withdraw') }}">
                        <span class="d-block " style=" font-size:13px ; color:#fff">Total Purchase Order / Halls</span>
                    </a>
                </div>
    ...
    <div class="card my-4">
        ...
        <div class="card-header">
            With Draw Balance Per  {{ date("F", mktime(0, 0, 0, Carbon\Carbon::now()->month, 1)) . " / " . Carbon\Carbon::now()->year  }}
        </div>
        <div class=" card-body ">
            ...
            <div class="d-flex justify-content-center align-items-center flex-wrap">
                ...
                <div class="card card-body px-1 py-3 mx-4 p bg-info   rounded my-3 order-statistics  position-relative">
                    ...
                    <a href="{{ route('admin.with-draw-request.total_withdraw_per_month') }}"><span class="d-block "
                            style=" font-size:13px ; color:#fff">Our Commission From Vendors</span></a>
                </div>
                ...
                <div class="card card-body px-1 py-3 mx-4 p bg-primary   rounded my-3 order-statistics  position-relative">
                    ...
                    <a href="{{ route('admin.with-draw-request.total_withdraw_per_month') }}"><span class="d-block "
                            style=" font-size:13px ; color:#fff">Total Vendors Balance</span></a>
                </div>
                <!---->
                <div class="card card-body px-1 py-3 mx-4 p bg-warning   rounded my-3 order-statistics  position-relative">
                    ...
                    <a href="{{ route('admin.with-draw-request.total_withdraw_per_month') }}"><span class="d-block "
                            style=" font-size:13px ; color:#fff">Total Sent Money</span></a>
                </div>
                ...
                <div class="card card-body px-1 py-3 mx-4 p bg-danger   rounded my-3 order-statistics  position-relative">
                    ...
                    <a href="{{ route('admin.with-draw-request.total_withdraw_per_month') }}"><span class="d-block "
                            style=" font-size:13px ; color:#fff">Total Vendors Credit</span></a>
                </div>
...
@else
            ...
            <div class=" card-body ">
                ...
                <div class="d-flex justify-content-center align-items-center flex-wrap">
                    ...
                    <div
                        ...
                        <a style="cursor: text"><span class="d-block "
                                style=" font-size:13px ; color:#fff">Our Credit</span></a>
                    </div>
                    ...
                    <div
                        ...
                        <a style="cursor: text""><span class="d-block "
                                style=" font-size:13px ; color:#fff">Our Money In Events</span></a>
                    </div>
    ...
    @if ($vendor->type == 'product' || $vendor->type == 'product_hall')
        <div class="card my-4">
            ...
            <div class="card-header">
                Total With Draw Balance Per {{ date("F", mktime(0, 0, 0, Carbon\Carbon::now()->month, 1)) . " / " . Carbon\Carbon::now()->year  }}
            </div>
            <div class=" card-body ">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header d-flex flex-row align-items-center flex-0 border-bottom">
                    ...
                    <div class="d-block">
                        ...
                        <div class="h4 fw-extrabold text-success">  @if ($useradmin->hasRole('super-admin') || $useradmin->hasRole('admin'))
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-header d-flex flex-row align-items-center flex-0 border-bottom">
                            ...
                            <div class="d-block">
                                ...
                                <div class="h3 fw-extrabold text-success">@if ($useradmin->hasRole('super-admin') || $useradmin->hasRole('admin'))
                                    {{ App\Models\Order::count() }}
                                @else
                                    {{ App\Models\Order::whereIn('id', $getOrdersProducts)->count() }}
                                @endif Order</div>
...
<script>
        ...
        options: {
            ...
            plugins: {
                title: {
                    ...
                    display: true,
                    text: (ctx) => 'Total Orders Is @if ($useradmin->hasRole('super-admin') || $useradmin->hasRole('admin')){{ App\Models\Order::count() }} @else {{App\Models\Order::whereIn('id',$getOrdersProducts)->count()}} @endif',
                }
            }
        }
    };
    ...
    const data4 = {
        ...
        datasets: [{
            label: 'Order',
            data: [{{ $newOrdersCount }},{{ $inprogressOrdersCount }}, {{ $deliveredOrdersCount }},{{ $cancelledOrdersCount }}],
    ...
    const config4 = {
        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: (ctx) => 'Total Orders Is @if ($useradmin->hasRole('super-admin') || $useradmin->hasRole('admin')){{ App\Models\Order::count() }} @else {{App\Models\Order::whereIn('id',$getOrdersProducts)->count()}} @endif Order ',
                },
