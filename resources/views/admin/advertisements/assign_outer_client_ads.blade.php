...
@section('title')
Assign Advertisments To Outer Clients
@endsection
    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class=" d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Assign Advertisments To Outer Clients</li>
            </ol>
        </nav>
        <h2 class="h4">Assign Advertisments To Outer Clients</h2>
