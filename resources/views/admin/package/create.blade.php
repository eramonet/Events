                ...
                <div class="row">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select required name="hall_id" id="hall_id"
                                ...
                                @foreach ($firstVendorHalls as $hall)
                                    <option value="{{ $hall->id }}">{{ $hall->title_en . ' ----- ' . $hall->title_ar }}
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-4">
                            ...
                            <input minlength="0" min="1" value="{{ old('number_of_tables') }}" required
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-4">
                            ...
                            <input minlength="0" min="1" value="{{ old('number_of_guests') }}" required
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <input minlength="0" min="1" value="{{ old('extra_guest_price') }}" required
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select multiple name="taxes[]" id="taxes"
                                ...
                                @foreach ($taxes as $tax)
                                    <option value="{{ $tax->id }}"
                                        {{ collect(old('taxes'))->contains($tax->id) ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea dir="rtl" name="meal_description_ar" id="meal_description_ar" cols="30" rows="3"
                                class="form-control @error('meal_description_ar') is-invalid @enderror">{{ old('meal_description_ar') }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea name="meal_description_en" id="meal_description_en" cols="30" rows="3"
                                class="form-control @error('meal_description_en') is-invalid @enderror">{{ old('meal_description_en') }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea dir="rtl" name="lighting_description_ar" id="lighting_description_ar" cols="30" rows="3"
                                class="form-control @error('lighting_description_ar') is-invalid @enderror">{{ old('lighting_description_ar') }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea name="lighting_description_en" id="lighting_description_en" cols="30" rows="3"
                                class="form-control @error('lighting_description_en') is-invalid @enderror">{{ old('lighting_description_en') }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea dir="rtl" name="sound_description_ar" id="sound_description_ar" cols="30" rows="3"
                                class="form-control @error('sound_description_ar') is-invalid @enderror">{{ old('sound_description_ar') }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea name="sound_description_en" id="sound_description_en" cols="30" rows="3"
                                class="form-control @error('sound_description_en') is-invalid @enderror">{{ old('sound_description_en') }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea dir="rtl" name="flowers_description_ar" id="flowers_description_ar" cols="30" rows="3"
                                class="form-control @error('flowers_description_ar') is-invalid @enderror">{{ old('flowers_description_ar') }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea name="flowers_description_en" id="flowers_description_en" cols="30" rows="3"
                                class="form-control @error('flowers_description_en') is-invalid @enderror">{{ old('flowers_description_en') }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea dir="rtl" name="decoration_description_ar" id="decoration_description_ar" cols="30"
                                rows="3" class="form-control @error('decoration_description_ar') is-invalid @enderror">{{ old('decoration_description_ar') }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea name="decoration_description_en" id="decoration_description_en" cols="30" rows="3"
                                class="form-control @error('decoration_description_en') is-invalid @enderror">{{ old('decoration_description_en') }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea dir="rtl" name="plan_of_the_day_description_ar" id="plan_of_the_day_description_ar" cols="30"
                                rows="3" class="form-control @error('plan_of_the_day_description_ar') is-invalid @enderror">{{ old('plan_of_the_day_description_ar') }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea name="plan_of_the_day_description_en" id="plan_of_the_day_description_en" cols="30" rows="3"
                                class="form-control @error('plan_of_the_day_description_en') is-invalid @enderror">{{ old('plan_of_the_day_description_en') }}</textarea>
                        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-4 d-flex justify-content-center">
                    <input required accept="image/*" type="file" name="image" data-max-file-size="10M"
