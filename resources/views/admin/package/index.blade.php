...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-2">
    <div class="d-block mb-4 mb-md-0">
        ...
        <h2 class="h4">All Packages</h2>

    </div>
    <div class="btn-toolbar mb-2 mb-md-0">
        @if (Auth::guard('admin')->user()->hasPermission('packages-create'))
        <a href="{{ route('admin.packages.create') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
        ...
        <div class="btn-group ms-2 ms-lg-3">
            <a href="{{ route('admin.packages.export') }}" class="btn btn-outline-success d-inline-flex align-items-center">
                {{-- <svg class="icon icon-xs me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg> --}}
            ...
            <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionPricing">
                  <div class="accordion-body card card-body ">
                    ...
                    <form action="{{ route('admin.packages.index') }}">
        ...
        <tbody >
            ...
            <tr>
               ...
               <td>
                   ...
                   <p ><i class="fas fa-calendar-week text-info"></i> {{ \Carbon\Carbon::parse($package->created_at)->format('d/m/Y')}} </p>
                   <p  ><i class="fas fa-clock text-success"></i> {{ \Carbon\Carbon::parse($package->created_at)->format('h:i:s A')}} </p>
                ...
                <td>
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu py-0">
                            <button data-bs-toggle="modal" data-bs-target="#modal-{{ $package->id }}" class="dropdown-item rounded-top" ><span class="fas fa-eye me-2"></span>View Details</button>

                            @if (Auth::guard('admin')->user()->hasPermission('packages-update'))
                            <a class="dropdown-item" href="{{ route('admin.packages.edit', $package->id) }}"><span class="fas fa-edit me-2"></span>Edit</a>
                            ...
                            @endif
                            @else
                            @if (Auth::guard('admin')->user()->hasPermission('packages-delete'))
                            <form class="delete-btn" action="{{ route('admin.packages.destroy', $package->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                ...
                <div class="modal fade" id="modal-{{ $package->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h2 class="h6 modal-title">{{ $package->title_en }}</h2>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="wrapper m-auto">
                                    ...
                                    <div class="d-flex mb-2">
                                        <img class="model-img" src="{{ $package->image_url }}" alt="{{ $package->title_en }} Image">
                                    </div>

                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">Title In Arabic : {{ $package->title_ar }} </li>
                                        <li class="list-group-item">Title In English : {{ $package->title_en }} </li>
                                        <li class="list-group-item">Price: {{ number_format($package->real_price )}} AED </li>
                                        <li class="list-group-item">Price With Taxes: {{ number_format($package->price_after_taxes)}} AED </li>
                                        ...
                                        <li class="list-group-item">Added By :
                                            ...
                                            <a class="btn btn-outline-primary" href="{{ route('admin.system-admins.index' ,[ 'admin_id'=>$package->admin->id ] )}}">{{ $package->admin->name }}</a>
                                            @else
                                               --
                                            @endif
                                        ...
                                        @if ($package->halls_count >0)

                                        <li class="list-group-item">Halls Count :

                                            <a class="btn btn-outline-primary" href="{{ route('admin.halls.index' ,[ 'vendor_id'=>$package->id ] )}}">{{ $package->halls_count }}</a>
                                        ...
                                        <li class="list-group-item">Vendor :
                                            ...
                                            <a class="btn btn-outline-primary" href="{{ route('admin.vendors.index' ,[ 'vendor_id'=>$package->vendor_id ] )}}">{{ $package->vendor->title_en . " - " .$package->vendor->title_ar}}</a>
                                        ...
                                        <li class="list-group-item">Hall :
                                            ...
                                            <a class="btn btn-outline-primary" href="{{ route('admin.halls.index' ,[ 'hall_id'=>$package->hall_id ] )}}">{{ $package->hall->title_en . " - " .$package->hall->title_ar}}</a>
                                        ...
                                        <li class="list-group-item">Category :
                                            ...
                                            <a class="btn btn-outline-primary" href="{{ route('admin.halls-categories.index' ,[ 'category_id'=>$package->category_id ] )}}">{{ $package->category->title_en . " - " .$package->category->title_ar}}</a>
                                        ...
                                        <li class="list-group-item">Added Date :  <i class="fas fa-calendar-week text-info"></i> {{ \Carbon\Carbon::parse($package->created_at)->format('d/m/Y')}}  </li>
                                        <li class="list-group-item">Added Time : <i class="fas fa-clock text-success"></i> {{ \Carbon\Carbon::parse($package->created_at)->format('h:i:s A')}}</li>
                            ...
                            <div class="modal-footer">
                                ...
                                @if (Auth::guard('admin')->user()->hasPermission('packages-update'))
                                <a class="btn btn-primary" href="{{ route('admin.packages.edit', $package->id) }}"><span class="fas fa-edit me-2"></span>Edit</a>
