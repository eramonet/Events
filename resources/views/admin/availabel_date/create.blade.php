...
<form action="{{ route('admin.availabel_date.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              {{-- title_ar --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input  required type="date" name="available_date" class="form-control @error('available_date') is-invalid @enderror" value="{{ old('available_date') }}">
                    </div>
              ...
              <div class="col-md-6">
                <div class="form-group mb-4">
                    ...
                    <select  required name="hall_id" id="vendor_id" class="form-select @error('hall_id') is-invalid @enderror">

                        @foreach ($halls as $hall)
                        <option value="{{ $hall->id }}" {{ old('vendor_id') ==$hall->id?'selected':''}}>{{ $hall->title_en .' - ' .$hall->title_ar}}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input  required type="time" name="time_from" class="form-control @error('time_from') is-invalid @enderror" value="{{ old('time_from') }}">
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input  required type="time" name="time_to" class="form-control @error('time_to') is-invalid @enderror" value="{{ old('time_to') }}">
                    </div>
