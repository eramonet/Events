    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class=" d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Unavailable DATES </li>
            </ol>
        </nav>
        <h2 class="h4">Unavailable DATES </h2>

    </div>
    <div class="btn-toolbar mb-2 mb-md-0">
        @if (Auth::guard('admin')->user()->hasPermission('packages-available-dates-and-times-create'))
        <a href="{{ route('admin.availabel_date.create') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
            <svg class="icon icon-xs me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg>
            Create New Unavailable Dates 
        </a>
        @endif

        <div class="btn-group ms-2 ms-lg-3">
            <a href="" class="btn btn-outline-success d-inline-flex align-items-center">
                {{-- <svg class="icon icon-xs me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg> --}}
            ...
            <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionPricing">
                  <div class="accordion-body card card-body ">
                    ...
                    <form action="{{ route('admin.availabel_date.index') }}">
    ...
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th class="border-gray-200">Hall Name</th>
        ...
        <tbody >
            ...
            <tr>
               ...
               <td>{{ $date->hall->title_en }} - {{ $date->hall->title_ar }} </td>
               ...
               <td>
                   @if ($date->created_at)
                   <p ><i class="fas fa-calendar-week text-info"></i> {{ \Carbon\Carbon::parse($date->created_at)->format('d/m/Y')}} </p>
                   <p  ><i class="fas fa-clock text-success"></i> {{ \Carbon\Carbon::parse($date->created_at)->format('h:i:s A')}} </p>
                ...
                <td>
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu py-0">
                            <button data-bs-toggle="modal" data-bs-target="#modal-{{ $date->id }}" class="dropdown-item rounded-top" ><span class="fas fa-eye me-2"></span>View Details</button>

                            @if (Auth::guard('admin')->user()->hasPermission('packages-available-dates-and-times-update'))
                            <a class="dropdown-item" href="{{ route('admin.availabel_date.edit', $date->id) }}"><span class="fas fa-edit me-2"></span>Edit</a>
                            ...
                            @if ($date->deleted_at)
                            @if (Auth::guard('admin')->user()->hasPermission('packages-available-dates-and-times-update'))
                            <form  action="{{ route('admin.availabel_date.restore', $date->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                            ...
                            @endif
                            @else
                            @if (Auth::guard('admin')->user()->hasPermission('packages-available-dates-and-times-delete'))
                            <form class="delete-btn" action="{{ route('admin.availabel_date.destroy', $date->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                ...
                <div class="modal fade" id="modal-{{ $date->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h2 class="h6 modal-title">{{ $date->available_date}}</h2>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="wrapper m-auto">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">Title In Arabic : {{ $date->hall->title_ar }} </li>
                                        <li class="list-group-item">Title In English : {{ $date->hall->title_en }} </li>
                                        ...
                                        <li class="list-group-item">Added Date :  <i class="fas fa-calendar-week text-info"></i> {{ \Carbon\Carbon::parse($date->created_at)->format('d/m/Y')}}  </li>
                                        <li class="list-group-item">Added Time : <i class="fas fa-clock text-success"></i> {{ \Carbon\Carbon::parse($date->created_at)->format('h:i:s A')}}</li>
                            ...
                            <div class="modal-footer">
                                ...
                                <a class="btn btn-primary" href="{{ route('admin.availabel_date.edit', $date->id) }}"><span class="fas fa-edit me-2"></span>Edit</a>
