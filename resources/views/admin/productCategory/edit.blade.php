                                ...
                                @foreach ($mainCategories as $mainCategory)
                                    @if ($mainCategory->id != $category->id)
                                        <option value="{{ $mainCategory->id }}"
                                            ...
                                            {{ $mainCategory->title_en . ' - ' . $mainCategory->title_ar }}</option>
                                    @endif
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea required dir="rtl" name="description_ar" id="description_ar" cols="30" rows="3"
                                class="form-control @error('description_ar') is-invalid @enderror">{{ $category->description_ar }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea name="description_en" id="description_en" cols="30" rows="3"
                                class="form-control @error('description_en') is-invalid @enderror">{{ $category->description_en }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea dir="rtl" name="keywords_ar" id="keywords_ar" cols="30" rows="2"
                                class="form-control @error('keywords_ar') is-invalid @enderror">{{ $category->keywords_ar }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea name="keywords_en" id="keywords_en" cols="30" rows="2"
                                class="form-control @error('keywords_en') is-invalid @enderror">{{ $category->keywords_en }}</textarea>
                        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-4 d-flex justify-content-center">
                    <input accept="image/*" data-default-file="{{ $category->image }}" type="file" name="image"
