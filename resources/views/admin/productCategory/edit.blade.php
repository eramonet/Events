    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class=" d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit  Products Category</li>

            </ol>
        </nav>
        <h2 class="h4">Edit  Products Category</h2>
              ...
              {{-- title_en --}}
                ...
                <div class="form-group mb-4">
                    ...
                    <select   name="parent_id" id="parent_id" class="form-select @error('parent_id') is-invalid @enderror">
                        ...
                        <option value="{{ $mainCategory->id }}" {{ $category->parent_id  ==$mainCategory->id ?'selected':''}}>{{ $mainCategory->title_en .' - '. $mainCategory->title_ar }}</option>
@endif
                        @endforeach
                    </select>
                </div>
        ...
        <div class="card-body">
                {{-- image --}}
                    ...
                    <div class="form-group mb-4 d-flex justify-content-center">
                        <input accept="image/*" data-default-file="{{ $category->image }}"  type="file" name="image"  data-max-file-size="10M" class="dropify @error('image') is-invalid @enderror" value="{{ old('image') }}">
                    </div>
