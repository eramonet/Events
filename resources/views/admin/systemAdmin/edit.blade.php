    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class=" d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item ">
                    <a href="{{ route('admin.system-admins.index') }}">System Admins</a>
                </li>

                <li class="breadcrumb-item active" aria-current="page">Edit System Admin</li>

            </ol>
        </nav>
        <h2 class="h4">Edit System Admin</h2>
...
<form action="{{ route('admin.system-admins.update', $admin->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{$admin->name  }}">
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ $admin->email }}">
                    </div>
              ...
              {{-- phone --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ $admin->phone  }}">
                    </div>
                   ...
                   <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <select required name="category_id" id="category_id" class="form-select @error('category_id') is-invalid @enderror">
                            ...
                            <option value="{{ $category->id }}" {{ $admin->category_id ==$category->id?'selected':'' }} >{{  $category->title_en  . ' - ' .$category->title_ar }}</option>
                            @endforeach
                        </select>
                    </div>
        ...
        <div class="card-body">
                {{-- image --}}
                    ...
                    <div class="form-group mb-4 d-flex justify-content-center">
                        <input accept="image/*"  type="file" name="image" data-default-file="{{ $admin->image_url }}"  data-max-file-size="10M" class="dropify @error('image') is-invalid @enderror" value="{{ old('image') }}">
                    </div>
                                ...
                                <div id="{{ $model }}" class="accordion-collapse collapse" aria-labelledby="heading-{{ $model }}" data-bs-parent="#accordionPermissions">
                                  <div class="accordion-body">
                                    ...
                                    <div class="form-group d-flex justify-content-between">
                                        ...
                                        <input {{ $admin->hasPermission($model.'-'. $crud ) ? 'checked':'' }} id="{{ $model.'-'. $crud  }}" type="checkbox" name="permissions[]" value="{{ $model.'-'. $crud  }}"  class="form-check-input">
                                    </div>
                                    @endforeach
                                  </div>
                                </div>
