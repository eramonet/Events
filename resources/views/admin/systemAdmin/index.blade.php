    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class=" d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page"> System Admins</li>
            </ol>
        </nav>
        <h2 class="h4">All System Admins</h2>

    </div>
    <div class="btn-toolbar mb-2 mb-md-0">
        @if (Auth::guard('admin')->user()->hasPermission('system-admins-create'))
        <a href="{{ route('admin.system-admins.create') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
        ...
        <div class="btn-group ms-2 ms-lg-3">
            <a href="{{ route('admin.system-admins.export') }}" class="btn btn-outline-success d-inline-flex align-items-center">
                {{-- <svg class="icon icon-xs me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg> --}}
            ...
            <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionPricing">
                  <div class="accordion-body card card-body ">
                    ...
                    <form action="{{ route('admin.system-admins.index') }}">
                ...
                <td>
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu py-0">
                            ...
                            @if (Auth::guard('admin')->user()->hasPermission('system-admins-update'))
                            <a class="dropdown-item" href="{{ route('admin.system-admins.edit', $admin->id) }}"><span class="fas fa-edit me-2"></span>Edit</a>
                            ...
                            @if ($admin->deleted_at)
                            @if (Auth::guard('admin')->user()->hasPermission('system-admins-update'))
                            <form  action="{{ route('admin.system-admins.restore', $admin->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                            ...
                            @endif
                            @else
                            @if (Auth::guard('admin')->user()->hasPermission('system-admins-delete'))
                            <form class="delete-btn" action="{{ route('admin.system-admins.destroy', $admin->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="wrapper m-auto">
                                    <div class="d-flex mb-2">
                                        <img class="model-img" src="{{ $admin->image_url }}" alt="{{ $admin->name }} Image">
                                    </div>
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item">Category :  {{ $admin->category ? $admin->category->title_en :'-' }}</li>


                                        <li class="list-group-item">Gender :  {{ $admin->gender }}</li>

                                        <li class="list-group-item">Role :  {{ $admin->roles ? $admin->roles[0]->name :'-' }} </li>
                            ...
                            <div class="modal-footer">
                                ...
                                @if (Auth::guard('admin')->user()->hasPermission('system-admins-update'))
                                <a class="btn btn-primary" href="{{ route('admin.system-admins.edit', $admin->id) }}"><span class="fas fa-edit me-2"></span>Edit</a>
