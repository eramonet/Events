              ...
              {{-- title_ar --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input dir="rtl" required type="text" name="title_ar" class="form-control @error('title_ar') is-invalid @enderror" value="{{ $option->title_ar  }}">
                    </div>
              ...
              {{-- title_en --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="text" name="title_en" class="form-control @error('title_en') is-invalid @enderror" value="{{  $option->title_en  }}">
                    </div>
               ...
               <div class="col-md-6">
                <div class="form-group mb-4">
                    ...
                    <select required name="category_id" id="category_id" class="form-select @error('category_id') is-invalid @enderror">
                        ...
                        <option value="{{ $category->id }}" {{  $option->category_id == $category->id ?'selected':''}}>{{  $category->title_en }}</option>
                        @endforeach
                    </select>
                </div>
        ...
        <div class="card-body">
                {{-- image --}}
                    ...
                    <div class="form-group mb-4 d-flex justify-content-center">
                        <input accept="image/*" data-default-file="{{ $option->image_url }}"  type="file" name="image"  data-max-file-size="10M" class="dropify @error('image') is-invalid @enderror" value="{{ old('image') }}">
                    </div>
