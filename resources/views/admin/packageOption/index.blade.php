...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-2">
    <div class="d-block mb-4 mb-md-0">
        ...
        <h2 class="h4">All Options </h2>

    </div>
    <div class="btn-toolbar mb-2 mb-md-0">
        @if (Auth::guard('admin')->user()->hasPermission('packages-options-create'))
        <a href="{{ route('admin.packages-options.create') }}"
            ...
            Create New Packages Option
        </a>
        @endif

        <div class="btn-group ms-2 ms-lg-3">
            <a href="{{ route('admin.packages-options.export') }}"
        ...
        <div class="accordion-item">
            ...
            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                ...
                <div class="accordion-body card card-body ">
                    ...
                    <form action="{{ route('admin.packages-options.index') }}">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control" aria-label="Default" name="status">
                                        ...
                                        <option value="1" @if (isset(request()->status) && request()->status == 1)
                                            selected @endif>Active
                                        </option>
                                        <option value="0" @if (isset(request()->status) && request()->status == 0)
                                            selected @endif>
                                            InActive</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control" aria-label="Default" name="deleted">
                                        ...
                                        <option value="0" @if (isset(request()->deleted) && request()->deleted == 0)
                                            selected @endif>Deleted
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control mb-3" aria-label="Default" name="limit">
                                        ...
                                        <option value="10" @if (isset(request()->limit) && request()->limit == 10)
                                            selected @endif>10
                                        </option>
                                        <option value="20" @if (isset(request()->limit) && request()->limit == 20)
                                            selected @endif>20
                                        </option>
                                        <option value="30" @if (isset(request()->limit) && request()->limit == 30)
                                            selected @endif>30
                                        </option>
                                        <option value="40" @if (isset(request()->limit) && request()->limit == 40)
                                            selected @endif>40
                                        </option>
                                        <option value="50" @if (isset(request()->limit) && request()->limit == 50)
                                            selected @endif>50
                                        </option>
                                        <option value="100" @if (isset(request()->limit) && request()->limit == 100)
                                            selected @endif>100
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control" aria-label="Default" name="order">
                                        ...
                                        <option value="ASC" @if (isset(request()->order) && request()->order == 'ASC')
                                            selected @endif>
                                            Oldest</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" id="to"
                                        value="{{ request()->to ? request()->to : date('Y-m-d', time()) }}" name="to"
                                        class="form-control search-docs" placeholder="To">
...
<div class="card card-body border-0 shadow table-wrapper table-responsive">
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $option->id }}</td>
                <td><img src="{{ $option->image_url }}" width="50px"></td>
                <td>{{ $option->title_ar }}</td>
                ...
                <td>
                    ...
                    <p><i class="fas fa-calendar-week text-info"></i>
                        {{ \Carbon\Carbon::parse($option->created_at)->format('d/m/Y') }} </p>
                    <p><i class="fas fa-clock text-success"></i>
                        {{ \Carbon\Carbon::parse($option->created_at)->format('h:i:s A') }} </p>
                    @else
                    ...
                    @endif
                ...
                <td>
                    <a href="{{ route('admin.packages-options.show' , $option->id) }}" class="btn btn-info"><span
                            class="fas fa-eye"></span></a>

                    @if (Auth::guard('admin')->user()->hasPermission('packages-options-update') && $option->can ==
                    "yes")
                    <a class="btn btn-primary" href="{{ route('admin.packages-options.edit', $option->id) }}"><span
                            class="fas fa-edit"></span></a>
                    @endif


                    @if (Auth::guard('admin')->user()->hasPermission('packages-options-delete') && $option->can ==
                    "yes")
                    <form style="display: contents" class="delete-btn"
                        action="{{ route('admin.packages-options.destroy', $option->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
...
<<<<<<< HEAD
                <div class="modal fade" id="modal-{{ $option->id }}" tabindex="-1" role="dialog"
                    aria-labelledby="modal-default" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h2 class="h6 modal-title">{{ $option->title_en }}</h2>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="wrapper m-auto">
                                    ...
                                    <div class="d-flex mb-2">
                                        <img class="model-img" src="{{ $option->image_url }}"
                                            alt="{{ $option->title_en }} Image">
                                    </div>

                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">Title In Arabic : {{ $option->title_ar }}
                                        </li>
                                        <li class="list-group-item">Title In English : {{ $option->title_en }}
                                        </li>
                                        ...
                                        <li class="list-group-item">Added By :
                                            ...
                                            <a class="btn btn-outline-primary"
                                                href="{{ route('admin.system-admins.index', ['admin_id' => $option->admin->id]) }}">{{
                                                $option->admin->name }}</a>
                                            @else
                                            --
                                            @endif
                                        ...
                                        <li class="list-group-item">Category:
                                            @if ($option->category)
                                            <a class="btn btn-outline-primary"
                                                href="{{ route('admin.packages-options-categories.index', ['id' => $option->category_id]) }}">{{
                                                $option->category->title_en . ' - ' . $option->category->title_ar }}</a>
                                            @else
                                            0
                                            @endif
                                        ...
                                        <li class="list-group-item">Added Date : <i
                                            ...
                                            {{ \Carbon\Carbon::parse($option->created_at)->format('d/m/Y') }} </li>
                                        <li class="list-group-item">Added Time : <i
                                                class="fas fa-clock text-success"></i>
                                            {{ \Carbon\Carbon::parse($option->created_at)->format('h:i:s A') }}
                                        </li>
                            ...
                            <div class="modal-footer">
                                ...
                                @if (Auth::guard('admin')->user()->hasPermission('packages-options-update'))
                                <a class="btn btn-primary"
                                    href="{{ route('admin.packages-options.edit', $option->id) }}"><span
    ...
    <div class="card-footer px-3 border-0 d-flex flex-column flex-lg-row align-items-center justify-content-between">
        {!! $options->appends(request()->query())->links('pagination::bootstrap-5') !!}



    </div>

    @if ($options->count() < 1) <div class="d-flex justify-content-center" style="min-height: 300px">
        Empty
</div>
@endif
</div>
            ...
            <tbody>
                ...
                @foreach ($options as $option)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.packages-options.show' , $option->id) }}" class="btn btn-info"><span class="fas fa-eye"></span></a>
                            ...
                            @if ($option->deleted_at)
                                @if (Auth::guard('admin')->user()->hasPermission('packages-options-update'))
                                    <form style="display: contents" action="{{ route('admin.packages-options.restore', $option->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                ...
                                @endif
                            @else
                                @if (Auth::guard('admin')->user()->hasPermission('packages-options-delete'))
                                    <form style="display: contents" class="delete-btn"
                                        action="{{ route('admin.packages-options.destroy', $option->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger">
                                        ...
                                        <div class="wrapper m-auto">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item">Added By :
                                                    ...
                                                    @if ($option->admin)
                                                        <a class="btn btn-outline-primary"
                                                            href="{{ route('admin.system-admins.index', ['admin_id' => $option->admin->id]) }}">{{ $option->admin->name }}</a>
                                                    @else
                                                        --
                                                    @endif
                                                ...
                                                <li class="list-group-item">Category:
                                                    @if ($option->category)
                                                        <a class="btn btn-outline-primary"
                                                            href="{{ route('admin.packages-options-categories.index', ['id' => $option->category_id]) }}">{{ $option->category->title_en . ' - ' . $option->category->title_ar }}</a>
                                                    @else
                                                        0
                                                    @endif
