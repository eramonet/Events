    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class=" d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item ">
                    <a href="{{ route('admin.packages-options.index') }}">Packages Option</a>
                </li>

                <li class="breadcrumb-item active" aria-current="page">Create New Packages Option </li>

            </ol>
        </nav>
        <h2 class="h4">Create New Packages Option </h2>
...
<form action="{{ route('admin.packages-options.store') }}" method="POST" enctype="multipart/form-data">
               ...
               <div class="col-md-6">
                <div class="form-group mb-4">
                    ...
                    <select required name="category_id" id="category_id" class="form-select @error('category_id') is-invalid @enderror">
                        ...
                        <option value="{{ $category->id }}" {{ old('category_id') == $category->id ?'selected':''}}>{{  $category->title_en }}</option>
                        @endforeach
                    </select>
                </div>
        ...
        <div class="card-body">
                {{-- image --}}
                    ...
                    <div class="form-group mb-4 d-flex justify-content-center">
                        <input  type="file" accept="image/*" name="image"  data-max-file-size="10M" class="dropify @error('image') is-invalid @enderror" value="{{ old('image') }}">
                    </div>
