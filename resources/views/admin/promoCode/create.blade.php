              ...
              {{-- title --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}">
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="date" name="expiration_date" class="form-control @error('expiration_date') is-invalid @enderror" value="{{ old('expiration_date') }}">
                    </div>
            ...
            {{-- value --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="number" name="value" class="form-control @error('value') is-invalid @enderror" value="{{ old('value') }}">
                    </div>
            ...
            {{-- maximum_times_of_use --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="number" name="maximum_times_of_use" class="form-control @error('maximum_times_of_use') is-invalid @enderror" value="{{ old('maximum_times_of_use') }}">
                    </div>
              ...
              <div class="col-md-6">
                <div class="form-group mb-4">
                    ...
                    <select required name="dedicated_to" id="dedicated_to" class="form-select @error('dedicated_to') is-invalid @enderror">
                        <option value="all_users" {{ old('dedicated_to') =='all_users'?'selected':''}}>All Users</option>
                        <option value="females" {{ old('dedicated_to') =='females'?'selected':''}}>Females</option>
                        <option value="males" {{ old('dedicated_to') =='males'?'selected':''}}>Males</option>
                        <option value="spacial_user" {{ old('dedicated_to') =='spacial_user'?'selected':''}}>Spacial User</option>
                        <option value="spacial_product" {{ old('dedicated_to') =='spacial_product'?'selected':''}}>Spacial Product</option>
