...
@endif --}}
                ...
                <div class="row">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select required name="dedicated_to" id="dedicated_to"
                                ...
                                <option value="spacial_product"
                                    {{ $promo->dedicated_to == 'spacial_product' ? 'selected' : '' }}>Spacial Product</option>
                    ...
                    <div class="col-md-6">
                        {{-- style="display: none" --}}
                        <div class="form-group mb-4 products_select"
                            style="display: {{ $promo->product ? 'block' : 'none' }}">
                            ...
                            <select name="product_id" id="product_id"
                                ...
                                @if ($promo->product)
                                    <option value="{{ $promo->product->id }}" selected>
                                        {{ $promo->product->title_en . '-' . $promo->product->title_ar }}</option>
                                @endif
                            </select>
                        </div>
