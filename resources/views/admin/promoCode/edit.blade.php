              ...
              {{-- title --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ $promo->title }}">
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="date" name="expiration_date" class="form-control @error('expiration_date') is-invalid @enderror" value="{{ $promo->expiration_date }}">
                    </div>
            ...
            {{-- value --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="number" name="value" class="form-control @error('value') is-invalid @enderror" value="{{ $promo->value }}">
                    </div>
              ...
              {{-- type --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <select required name="type" id="type" class="form-select @error('type') is-invalid @enderror">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        <label for="maximum_times_of_use"> Maximum Times of Use  <span class="text-danger">*</span></label>
                        <input required type="number" name="maximum_times_of_use" class="form-control @error('maximum_times_of_use') is-invalid @enderror" value="{{ $promo->maximum_times_of_use }}">
                    </div>
...
@endif --}}
             ...
             {{-- dedicated_to --}}
              <div class="col-md-6">
                <div class="form-group mb-4">
                    ...
                    <select required name="dedicated_to" id="dedicated_to" class="form-select @error('dedicated_to') is-invalid @enderror">
                        <option value="all_users" {{ $promo->dedicated_to =='all_users'?'selected':''}}>All Users</option>
                        <option value="females" {{ $promo->dedicated_to =='females'?'selected':''}}>Females</option>
                        <option value="males" {{ $promo->dedicated_to =='males'?'selected':''}}>Males</option>
                        <option value="spacial_user" {{ $promo->dedicated_to =='spacial_user'?'selected':''}}>Spacial User</option>
                        <option value="spacial_product" {{ $promo->dedicated_to =='spacial_product'?'selected':''}}>Spacial Product</option>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group mb-4 users_select" style="display: {{ $promo->user?'block':'none' }}"  >
                    ...
                    <select  name="user_id" id="user_id" class="form-select @error('user_id') is-invalid @enderror">
                        ...
                        @if ($promo->user)
                        <option value="{{ $promo->user->id }}"  selected>{{ $promo->user->name . '-' .$promo->phone }}</option>
    ...
    <div class="col-md-6">
        {{-- style="display: none" --}}
        <div class="form-group mb-4 products_select" style="display: {{ $promo->product?'block':'none' }}"  >
            ...
            <select  name="product_id" id="product_id" class="form-select @error('product_id') is-invalid @enderror">
                ...
                @if ($promo->product)
                <option value="{{ $promo->product->id }}"  selected>{{ $promo->product->title_en . '-' .$promo->product->title_ar }}</option>
