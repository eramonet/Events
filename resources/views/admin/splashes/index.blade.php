    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class=" d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Splashes</li>
            </ol>
        </nav>
        <h2 class="h4">All Splashes</h2>

    </div>
    <div class="btn-toolbar mb-2 mb-md-0">
        @if (Auth::guard('admin')->user()->hasPermission('splashes-create'))
        <a href="{{ route('admin.splashes.create') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
            ...
            <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionPricing">
                  <div class="accordion-body card card-body ">
                    ...
                    <form action="{{ route('admin.splashes.index') }}">
...
<div class="card card-body border-0 shadow table-wrapper table-responsive">
    <table class="table table-hover table-centered table-striped table-bordered text-center">
        ...
        <tbody >
            ...
            <tr>
                ...
                <td>
                    <p class="text-nowrap">{{ $splash->id }}.</p>
                </td>
                ...
                <td>
                    ...
                    <div class="m-auto" style="width:250px">
                        <p class="" dir="rtl">{{ Str::limit($splash->title_ar, 60) }}</p>
                        <p class="">{{ Str::limit($splash->title_en, 60) }}</p>
                    </div>
                </td>
                ...
                <td>
                    ...
                    <div class="d-flex  align-items-center justify-content-center flex-md-nowrap">
                        ...
                        <div class="">
                            <div data-bs-toggle="tooltip" data-bs-placement="top" title="Show Details">
                                <button class="btn btn-primary  m-1" data-bs-toggle="modal"
                                    data-bs-target="#modal-{{ $splash->id }}" class=""><span
                        ...
                        <div class="">
                            @if (Auth::guard('admin')->user()->hasPermission('splashes-update'))
                                <a class="btn btn-info m-1" class="dropdown-item"
                                    href="{{ route('admin.splashes.edit', $splash->id) }}" title="Edit"
                        ...
                        <div class="">
                            @if ($splash->deleted_at)
                                @if (Auth::guard('admin')->user()->hasPermission('splashes-update'))
                                    <form action="{{ route('admin.splashes.restore', $splash->id) }}" method="POST"
                                ...
                                @endif
                            @else
                                @if (Auth::guard('admin')->user()->hasPermission('splashes-delete'))
                                    <form class="delete-btn m-0 p-0 "
                                        action="{{ route('admin.splashes.destroy', $splash->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
            ...
            <div class="modal fade" id="modal-{{ $splash->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h2 class="h6 modal-title">{{ $splash->title_en }}</h2>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="wrapper m-auto">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">Title In Arabic : {{ $splash->title_ar }} </li>
                                    <li class="list-group-item">Title In English : {{ $splash->title_en }} </li>
                                    ...
                                    <li class="list-group-item">Added Date :  <i class="fas fa-calendar-week text-info"></i> {{ \Carbon\Carbon::parse($splash->created_at)->format('d/m/Y')}}  </li>
                                    <li class="list-group-item">Added Time : <i class="fas fa-clock text-success"></i> {{ \Carbon\Carbon::parse($splash->created_at)->format('h:i:s A')}}</li>
                        ...
                        <div class="modal-footer">
                            ...
                            @if (Auth::guard('admin')->user()->hasPermission('splashes-update'))
                            <a class="btn btn-primary" href="{{ route('admin.splashes.edit', $splash->id) }}"><span class="fas fa-edit me-2"></span>Edit</a>
    ...
    <div class="card-footer px-3 border-0 d-flex flex-column flex-lg-row align-items-center justify-content-between">
        {!! $splashes->appends(request()->query())->links('pagination::bootstrap-5')!!}
