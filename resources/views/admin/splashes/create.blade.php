    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class=" d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item ">
                    <a href="{{ route('admin.blogs.index') }}">Splashes</a>
                </li>

                <li class="breadcrumb-item active" aria-current="page">Create New Splash</li>

            </ol>
        </nav>
        <h2 class="h4">Create New Splash</h2>
...
<form action="{{ route('admin.splashes.store') }}" method="POST" enctype="multipart/form-data">
                ...
                {{-- title_en --}}
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea dir="rtl" name="details_ar" id="details_ar" cols="30" rows="6"
                                class="form-control @error('details_ar') is-invalid @enderror"></textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            <label for="details_en"> Description In English </label>


                            <textarea name="details_en" id="details_en" cols="30" rows="6"
                                class="form-control @error('details_en') is-invalid @enderror"></textarea>
                        </div>
 ...
 <div class="card mb-4">
        ...
        <div class="card-body">
                {{-- primary_image --}}
                     ...
                     <span class="text-danger">Prefer {{ config('imageDimensions.splashes.width').'*'. config('imageDimensions.splashes.height') }} Pixels</span>
