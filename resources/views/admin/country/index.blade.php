                        ...
                        <td>
                            @if ($country->created_at)
                                <p><i class="fas fa-calendar-week text-info"></i>
                                    {{ \Carbon\Carbon::parse($country->created_at)->format('d/m/Y') }} </p>
                                <p><i class="fas fa-clock text-success"></i>
                                    {{ \Carbon\Carbon::parse($country->created_at)->format('h:i:s A') }} </p>
                            @else
                                ...
                            @endif
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h2 class="h6 modal-title">{{ $country->title_en }}</h2>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="wrapper m-auto">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item">Title In Arabic : {{ $country->title_ar }}
                                                </li>
                                                <li class="list-group-item">Title In English : {{ $country->title_en }}
                                                </li>
                                                <li class="list-group-item">Shortcut : {{ $country->shortcut }}</li>
                                                <li class="list-group-item">Code : {{ $country->code }}</li>
                                                <li class="list-group-item">Cites Count : {{ $country->cities_count }}
                                                </li>
                                                ...
                                                <li class="list-group-item">Added By :
                                                    ...
                                                    @if ($country->admin)
                                                        <a class="btn btn-outline-primary"
                                                            href="{{ route('admin.system-admins.index', ['admin_id' => $country->admin->id]) }}">{{ $country->admin->name }}</a>
                                                    @else
                                                        --
                                                    @endif
                                                ...
                                                <li class="list-group-item">Added Time : <i
                                                    ...
                                                    {{ \Carbon\Carbon::parse($country->created_at)->format('h:i:s A') }}
                                                </li>
