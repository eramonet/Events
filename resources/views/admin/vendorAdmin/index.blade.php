    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-2">
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class=" d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Vendor Admins</li>
                </ol>
            </nav>
            <h2 class="h4">All Vendor Admins</h2>
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            ...
            @if (Auth::guard('admin')->user()->vendor)
                ...
                @if (Auth::guard('admin')->user()->vendor->vendor_admin >
                        Auth::guard('admin')->user()->vendor->admin->count())
            ...
            <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="accordion-body card card-body ">
                        ...
                        <form action="{{ route('admin.vendor-admins.index') }}">
                        ...
                        <td>
                            @if ($admin->created_at)
                                ...
                                <p><i class="fas fa-clock text-success"></i>
                                    {{ \Carbon\Carbon::parse($admin->created_at)->format('h:i:s A') }} </p>
                            @else
                                ...
                            @endif
                                        ...
                                        <div class="wrapper m-auto">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item">Category :
                                                    {{ $admin->category ? $admin->category->title_en : '-' }}</li>
                                                ...
                                                <li class="list-group-item">Vendor :
                                                    ...
                                                    @if ($admin->vendor)
                                                        <a class="btn btn-outline-primary"
                                                            href="{{ route('admin.vendors.index', ['vendor_id' => $admin->vendor->id]) }}">{{ $admin->vendor->title_en . ' - ' . $admin->vendor->title_ar }}</a>
                                                    @else
                                                        --
                                                    @endif
                                                ...
                                                <li class="list-group-item">Added By :
                                                    ...
                                                    @if ($admin->added_by_admin)
                                                        @if ($admin->added_by_admin && $admin->added_by_admin->roles && $admin->added_by_admin->roles[0]->name == 'vendor-admin')
                                                            <a class="btn btn-outline-primary"
                                                                href="{{ route('admin.vendor-admins.index', ['admin_id' => $admin->added_by_admin->id]) }}">{{ $admin->added_by_admin->name }}</a>
                                                        @else
                                                            <a class="btn btn-outline-primary"
                                                                href="{{ route('admin.system-admins.index', ['admin_id' => $admin->added_by_admin->id]) }}">{{ $admin->added_by_admin->name }}</a>
                                                        @endif
                                                    @else
                                                        --
                                                    @endif
