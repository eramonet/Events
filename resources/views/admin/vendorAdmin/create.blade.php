    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class=" d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Create New Vendor Admin</li>

            </ol>
        </nav>
        <h2 class="h4">Create New Vendor Admin</h2>
...
<form action="{{ route('admin.vendor-admins.store') }}" method="POST" enctype="multipart/form-data">
                   ...
                   <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <select required name="vendor_id" id="vendor_id" class="form-select @error('vendor_id') is-invalid @enderror">
                            ...
                            <option value="{{ $vendor->id }}" {{ old('vendor_id') ==$vendor->id?'selected':''}}  >{{  $vendor->title_en  . ' - ' .$vendor->title_ar }}</option>
                            @endforeach
                        </select>
                    </div>
