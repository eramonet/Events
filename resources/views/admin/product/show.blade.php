...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input dir="rtl" readonly type="text" name="title_ar"
                            class="form-control @error('title_ar') is-invalid @enderror" value="{{ $product->title_ar }}">
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input readonly type="text" name="title_en"
                            class="form-control @error('title_en') is-invalid @enderror" value="{{ $product->title_en }}">
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input minlength="0" readonly type="number" name="stock"
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input minlength="0" min="1" readonly type="number" name="purchase_price"
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input minlength="0" min="1" readonly type="number" name="real_price"
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input minlength="0" min="1" readonly type="number" name="fake_price"
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input readonly type="text" name="category_id"
                            ...
                            value="{{ $product->main_category->title_en . ' - ' . $product->main_category->title_ar }}">
                    </div>
                ...
                {{-- <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input readonly type="text" name="city_id"
                            ...
                            value="{{ $product->city->title_en . ' - ' . $product->city->title_ar }}">
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        {{-- <select readonly name="category_id" id="subCategoriesSelect"
                        ...
                        <input readonly type="text" name="category_id"
                            class="form-control @error('category_id') is-invalid @enderror"
                            value="{{ $product->category->title_en . ' - ' . $product->category->title_ar }}">
                        {{-- </select> --}}
                    </div>
                ...
                {{-- <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <select readonly multiple name="occasion_id[]" id="taxes"
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input readonly type="text" name="status"
                            ...
                            value="@if ($product->status == '0') InActive @else Active @endif">
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <textarea readonly dir="rtl" name="features_ar" id="features_ar" cols="30" rows="2"
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <textarea readonly name="features_en" id="features_en" cols="30" rows="2"
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <textarea readonly dir="rtl" name="instructions_ar" id="instructions_ar" cols="30" rows="2"
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <textarea readonly name="instructions_en" id="instructions_en" cols="30" rows="2"
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <textarea readonly dir="rtl" name="summary_ar" id="summary_ar" cols="30" rows="2"
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <textarea readonly name="summary_en" id="summary_en" cols="30" rows="2"
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <textarea readonly dir="rtl" name="extras_ar" id="extras_ar" cols="30" rows="2"
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <textarea readonly name="extras_en" id="extras_en" cols="30" rows="2"
    ...
    <a href="{{ route('admin.products.index') }}" class="btn btn-primary d-block m-auto">
        Back
