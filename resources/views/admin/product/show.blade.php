                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        @foreach ($product->media as $media)
                                            <img src="{{ $media->image }}" style="width: 150px">
                                        @endforeach
                                    ...
                                    <li class="list-group-item">Limitation : {{ $product->limitation }} Item </li>

                                    <li class="list-group-item">Model Number : {{ $product->model_number }} </li>

                                    <li class="list-group-item">Ordering Number : {{ $product->buying_count->count() }} </li>
