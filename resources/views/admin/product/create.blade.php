                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <input minlength="0" value="{{ old('stock') ? old('stock') : '100' }}" required type="number"
                            ...
                            <select required multiple name="occasion_id[]" id="occasion_id"
                                ...
                                @foreach ($occasions as $occasion)
                                    <option value="{{ $occasion->id }}"
                                        {{ collect(old('occasions'))->contains($occasion->id) ? 'selected' : '' }}>
                            ...
                            <select multiple name="products_with[]" id="products_with"
                                ...
                                @foreach ($products as $product_item)
                                    <option value="{{ $product_item->id }}"
                                        {{ collect(old('products_with'))->contains($product_item->id) ? 'selected' : '' }}>
                    ...
                    {{-- <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <select required name="in_stock" id="in_stock"
                                ...
                                <option value="1" {{ old('in_stock') == '1' ? 'selected' : '' }}>No</option>
                                <option value="0" {{ old('in_stock') == '0' ? 'selected' : '' }}>Yes</option>
                            </select>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-4">
                            ...
                            <textarea editor dir="rtl" name="details_ar" id="details_ar" cols="30" rows="6"
                                class="form-control @error('details_ar') is-invalid @enderror">{!! old('details_ar') !!}</textarea>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-4">
                            ...
                            <textarea editor name="details_en" id="details_en" cols="30" rows="6"
                                class="form-control @error('details_en') is-invalid @enderror">{!! old('details_en') !!}</textarea>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-4">
                            ...
                            <input required type="text" name="model_number"
                                class="form-control @error('model_number') is-invalid @enderror" value="{{ old('model_number') }}">
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-4">
                            ...
                            <input required type="number" name="limitation"
                                class="form-control @error('limitation') is-invalid @enderror" value="{{ old('limitation') }}">
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea required dir="rtl" name="features_ar" id="features_ar" cols="30" rows="2"
                                class="form-control @error('features_ar') is-invalid @enderror">{{ old('features_ar') }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea required name="features_en" id="features_en" cols="30" rows="2"
                                class="form-control @error('features_en') is-invalid @enderror">{{ old('features_en') }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea required name="instructions_en" id="instructions_en" cols="30" rows="2"
                                class="form-control @error('instructions_en') is-invalid @enderror">{{ old('instructions_en') }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea required dir="rtl" name="extras_ar" id="extras_ar" cols="30" rows="2"
                                class="form-control @error('extras_ar') is-invalid @enderror">{{ old('extras_ar') }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea required name="extras_en" id="extras_en" cols="30" rows="2"
                                class="form-control @error('extras_en') is-invalid @enderror">{{ old('extras_en') }}</textarea>
                        </div>
