...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-2">
    ...
    <a data-bs-toggle="modal" data-bs-target="#modal-store"
    ...
    <table class="table table-hover table-centered table-striped table-bordered text-center ">
        <thead>
            <tr>
                ...
                <th class="border-gray-200">Intro title [en]</th>
                <th class="border-gray-200">Big Text [en]</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <p class="text-nowrap"> {{ $slider->intro_title_en }} </p>
                </td>

                <td>
                    <p class="text-nowrap"> {{ $slider->big_text_en }} </p>
                </td>

                <td>
                    <p class="text-nowrap"> {{ substr($slider->description_en, 0, 30) }} </p>
                </td>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="wrapper m-auto">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <label> Introduction Title [en] </label>
                                            <input type="text" name="intro_title_en"
                                                value="{{ $slider->intro_title_en }}" class="form-control"><br>

                                            <label> Introduction Title [ar] </label>
                                            <input type="text" name="intro_title_ar"
                                                value="{{ $slider->intro_title_ar }}" class="form-control"><br>

                                            <label> Big Text [en] </label>
                                            <input type="text" name="big_text_en" value="{{ $slider->big_text_en }}"
                                                class="form-control"><br>

                                            <label> Big Text [ar] </label>
                                            <input type="text" name="big_text_ar" value="{{ $slider->big_text_ar }}"
                                                class="form-control"><br>
...
<div class="modal fade" id="modal-store" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="{{ route('admin.user-front-settings.store_main_slider') }}" method="POST"
                ...
                <div class="modal-body">
                    ...
                    <div class="wrapper m-auto">
                        ...
                        <ul class="list-group list-group-flush">
                            <label>Main Image </label>
                            <div class="col-md-12 mb-2">
                                <img id="preview-image2" src="" alt="preview image2" width="100px">
                            </div>
                            <input type="file" name="main_image" placeholder="Choose image" id="image2"
                                accept="image/x-png,image/jpeg"><br>
                            <label> Introduction Title [en] </label>
                            <input type="text" name="intro_title_en" value="{{ old('$slider->intro_title_en') }}"
                                class="form-control"><br>

                            <label> Introduction Title [ar] </label>
                            <input type="text" name="intro_title_ar" value="{{ old('$slider->intro_title_ar') }}"
                                class="form-control"><br>

                            <label> Big Text [en] </label>
                            <input type="text" name="big_text_en" value="{{ old('$slider->big_text_en') }}"
                                class="form-control"><br>

                            <label> Big Text [ar] </label>
                            <input type="text" name="big_text_ar" value="{{ old('$slider->big_text_ar') }}"
                                class="form-control"><br>

                            <label> Description [en] </label>
                            <input type="text" name="description_en" value="{{ old('$slider->description_en') }}"
                                class="form-control"><br>

                            <label> Description [ar] </label>
                            <input type="text" name="description_ar" value="{{ old('$slider->description_ar') }}"
                                class="form-control"><br>

                            <label> Link </label>
                            <input type="text" name="link" value="{{ old('$slider->link') }}" class="form-control"><br>
                        </ul>
                    </div>
