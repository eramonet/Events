    ...
    <table class="table table-hover table-centered table-striped table-bordered text-center ">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <p class="text-nowrap"> {{ substr($main_section->description_en, 0, 30) }} </p>
                </td>
                ...
                <div class="modal fade" id="modal-edit-{{ $main_section->id }}" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form
                                action="{{ route('admin.user-front-settings.edit_main_section_footer_footer' , $main_section->id) }}"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="wrapper m-auto">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <input type="file" name="logo" placeholder="Choose image" id="image2"
                                                accept="image/x-png,image/jpeg"><br>
                                            <label> Description [en] </label>
                                            <input type="text" name="description_en"
                                                value="{{ $main_section->description_en }}" class="form-control"><br>

                                            <label> Description [ar] </label>
                                            <input type="text" name="description_ar"
                                                value="{{ $main_section->description_ar }}" class="form-control"><br>

                                            <label> Google Play Link </label>
                                            <input type="text" name="google_play_link"
                                                value="{{ $main_section->google_store_link }}" class="form-control"><br>

                                            <label> Apple Store Link </label>
                                            <input type="text" name="apple_store_link"
                                                value="{{ $main_section->app_store_link }}" class="form-control"><br>
                                        </ul>
                                    </div>
