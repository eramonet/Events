        ...
        <table class="table table-hover table-centered table-striped table-bordered text-center ">
            <thead>
                <tr>
                    ...
                    <th class="border-gray-200">Sub Title (en)</th>
                    <th class="border-gray-200">Title (ar)</th>
                    <th class="border-gray-200">Sub Title (ar)</th>
            ...
            <tbody>
                ...
                @foreach ($our_features as $our_feature)
                    <tr>
                        ...
                        <td>
                            <p class="text-nowrap"> {{ $our_feature->title_en }} </p>
                        </td>

                        <td>
                            <p class="text-nowrap"> {{ $our_feature->sub_title_en }} </p>
                        </td>

                        <td>
                            <p class="text-nowrap"> {{ $our_feature->title_ar }} </p>
                        </td>

                        <td>
                            <p class="text-nowrap"> {{ $our_feature->sub_title_ar }} </p>
                        </td>
                                            ...
                                            <div class="wrapper m-auto">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <input type="text" name="title_en"
                                                        value="{{ $our_feature->title_en }}" class="form-control"><br>

                                                    <label> Sub Title (en) </label>
                                                    <input type="text" name="sub_title_en"
                                                        value="{{ $our_feature->sub_title_en }}" class="form-control"><br>

                                                    <label> Title (ar) </label>
                                                    <input type="text" name="title_ar"
                                                        value="{{ $our_feature->title_ar }}" class="form-control"><br>

                                                    <label> Sub Title (ar) </label>
                                                    <input type="text" name="sub_title_ar"
                                                        value="{{ $our_feature->sub_title_ar }}" class="form-control"><br>
                                                </ul>
                                            </div>
