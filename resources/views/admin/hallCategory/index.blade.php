    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class=" d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Halls Categories</li>
            </ol>
        </nav>
        <h2 class="h4">All Halls  Categories</h2>

    </div>
    <div class="btn-toolbar mb-2 mb-md-0">
        {{-- @if (Auth::guard('admin')->user()->hasPermission('halls-categories-create')) --}}
        <a href="{{ route('admin.halls-categories.create') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
        ...
        <div class="btn-group ms-2 ms-lg-3">
            <a href="{{ route('admin.halls-categories.export',) }}" class="btn btn-outline-success d-inline-flex align-items-center">
                {{-- <svg class="icon icon-xs me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg> --}}
            ...
            <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionPricing">
                  <div class="accordion-body card card-body ">
                    ...
                    <form action="{{ route('admin.halls-categories.index') }}">
                ...
                <td>
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu py-0">
                            ...
                            {{-- @if (Auth::guard('admin')->user()->hasPermission('halls-categories-update')) --}}
                            <a class="dropdown-item" href="{{ route('admin.halls-categories.edit', $category->id) }}"><span class="fas fa-edit me-2"></span>Edit</a>
                            ...
                            {{-- @if (Auth::guard('admin')->user()->hasPermission('halls-categories-update')) --}}
                            <form  action="{{ route('admin.halls-categories.restore', $category->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                            ...
                            {{-- @endif --}}
                            @else
                            {{-- @if (Auth::guard('admin')->user()->hasPermission('halls-categories-delete')) --}}
                            <form class="delete-btn" action="{{ route('admin.halls-categories.destroy', $category->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                                ...
                                <div class="wrapper m-auto">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item">Sub Categories Count :
                                            ...
                                            <a class="btn btn-outline-primary" href="{{ route('admin.halls-categories.index' ,[ 'type'=>'sub', 'parent_id'=>$category->id ] )}}">{{ $category->sub_catagories_count }}</a>
                                        ...
                                        <li class="list-group-item">Halls Count :
                                            @if ($category->halls_count >0)

                                            <a class="btn btn-outline-primary" href="{{ route('admin.halls.index' ,[ 'category_id'=>$category->id ] )}}">{{ $category->halls_count }}</a>
                            ...
                            <div class="modal-footer">
                                ...
                                {{-- @if (Auth::guard('admin')->user()->hasPermission('halls-categories-update')) --}}
                                <a class="btn btn-primary" href="{{ route('admin.halls-categories.edit', $category->id) }}"><span class="fas fa-edit me-2"></span>Edit</a>
