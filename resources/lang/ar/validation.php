...
return [
    ...
    'attributes' => [
        ...
        'price' => 'السعر',
        'count' => 'العدد',
        'typeContact' => 'نوع المرسل',
        'message' => 'الرساله',
        'type' => 'نوع الرساله',
        'page' => 'رقم الصفحة',
        'per_page' => 'عدد المنتجات في الصفحة',
        'total' => 'المجموع الكلي لكل طلب',
        'media' => 'الصور مطلوبة',
        'pdf' => 'ملف ال pdf مطلوب',
