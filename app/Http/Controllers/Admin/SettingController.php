...
public function update(Request $request)
{
    ...
    $request->validate([
        ...
        'facebook_link'=>['nullable','string','min:2'],
        'instagram_link'=>['nullable','string','min:2'],
        'twitter_link'=>['nullable','string','min:2'],
        'youtube_link'=>['nullable','string','min:2'],
        'tiktok_link'=>['nullable','string','min:2'],
        'linkedin_link'=>['nullable','string','min:2'],
        'pinterest_link'=>['nullable','string','min:2'],
