...
class HallController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($useradmin->hasRole('super-admin') || $useradmin->hasRole('admin')) {
            ...
            $halls = Hall::where("admin_id", $vendor->id)->paginate(10);
    ...
    public function create(Request $request)
    {
        ...
        return \view('admin.hall.create', \compact('cities', 'vendors', 'hallCategories', 'taxes'));
    }
    ...
    public function hall_request($status)
    {
        if (Auth::guard('admin')->user()->vendor) { // vendor
            ...
            $halls = Hall::where([
                [ 'accept', $status ] ,
                [ 'admin_id' , Auth::guard('admin')->user()->vendor->id ]
            ])->paginate(10);
        }else{
