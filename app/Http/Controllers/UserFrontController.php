...
class UserFrontController extends Controller
{
    ...
    public function question_and_requests()
    {
        $questions = QuestionsAndRequests::latest()->get();
        return view('admin.userFrontSettings.questions_and_requests', compact('questions'));
    }
    ...
    public function store_main_slider(AddMainSliderRequest $request)
    {
        ...
        MainSlider::create([
            ...
            "intro_title_en" => $request->intro_title_en,
            "big_text_en" => $request->big_text_en,
            "description_en" => $request->description_en,
            "intro_title_ar" => $request->intro_title_ar,
